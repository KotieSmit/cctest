...
class WebGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     * @param WebGuy $I
     * @param string $gender
     * @see Codeception\Module\TestHelper::signupForNewslettersFromRoadblock()
     * @return \Codeception\Maybe
     */
    public function signupForNewslettersFromRoadblock($I, $gender = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('signupForNewslettersFromRoadblock', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     * @param WebGuy $I
     * @param string $gender
     * @see Codeception\Module\TestHelper::signupForNewslettersFromHomePageTop()
     * @return \Codeception\Maybe
     */
    public function signupForNewslettersFromHomePageTop($I, $gender = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('signupForNewslettersFromHomePageTop', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\TestHelper::signupForNewslettersFromPageFooter()
     * @return \Codeception\Maybe
     */
    public function signupForNewslettersFromPageFooter($I, $page = null, $gender = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('signupForNewslettersFromPageFooter', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
